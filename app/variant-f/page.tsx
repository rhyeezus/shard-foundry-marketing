...
/*
 * Hero = enchanted forest video (background), with masking fade to transparent.
 * Real HTML headline + CTAs are overlaid on top so they stay crisp, clickable and accessible.
 */
const HERO_VIDEO = '/assets/forest-theme.mp4';
...
const stats = [
  { value: '15+', label: 'Years building the national curriculum', accent: '#00e5a0' },
  { value: '2016', label: 'ACCE/ACS ICT Educator of the Year', accent: '#FF7A1F' },
  { value: 'v9.0', label: 'AC: Digital Technologies aligned', accent: '#e040a0' },
];
...
export default function VariantF() {
  return (
    <div
      ...
      style={{
        // Atmospheric depth: lighter forest green at the top deepening to
        // near-black, arriving naturally at the footer's #020908.
        background: 'linear-gradient(180deg, #0d2d1a 0%, #0a2415 30%, #06140d 65%, #020908 100%)',
        minHeight: '100vh',
      }}
    >
      <Nav theme="forest" />
      ...
      <section
        ...
        style={{
          minHeight: '100svh',
          // Transparent so the page-level forest gradient shows through. The
          // art is masked to fade into it, so the hero and the page below
          // merge with no seam.
          backgroundColor: 'transparent',
        }}
      >
        {/* Hero video — masked so it dissolves to transparent at the bottom, leaving
            the page gradient to meet the below-fold seamlessly. No hard edge. */}
        <video
      ...
      {/* ══ BELOW-FOLD — transparent so the page gradient runs through, merging with the hero ══ */}
      <div className="relative" style={{ backgroundColor: 'transparent' }}>
        {/* ── Intro + feature bento ── */}
        <section className="relative pt-28 pb-24">
          <Container className="relative">
            <div className="max-w-2xl mb-14">
              <Eyebrow color="#00e5a0">The platform</Eyebrow>
        ...
        <section id="platform" className="relative py-24">
          <Container className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            {/* Copy + stats */}
            <div>
              <Eyebrow color="#00e5a0">Teacher command centre</Eyebrow>
        ...
        <section id="technologies" className="relative py-24">
          <div
            ...
            style={{ background: 'radial-gradient(80% 140% at 70% 45%, rgba(0,229,160,0.10), transparent 80%)' }}
          />
          <Container className="relative">
            <div className="grid lg:grid-cols-2 gap-14 items-stretch mb-20">
              {/* Authority card */}
              <div className="relative flex flex-col justify-center rounded-3xl border border-white/10 p-10" style={{ background: 'linear-gradient(160deg, #123524, #0a2415)' }}>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {curriculum.map((m) => (
                  <div key={m.title} className="relative rounded-2xl border border-white/10 bg-white/[0.03] p-6 overflow-hidden hover:border-white/20 transition-colors">
                    <div className="absolute left-0 top-0 h-full w-1" style={{ background: 'linear-gradient(180deg,#00e5a0,#80ffcc)' }} />
        ...
        <section id="mission" className="relative py-28">
          <div
            ...
            style={{ background: 'radial-gradient(70% 100% at 50% 50%, rgba(0,229,160,0.10), transparent 80%)' }}
          />
          <Container className="relative">
            <div className="max-w-3xl mx-auto text-center">
              <Eyebrow color="#e040a0">Mission</Eyebrow>
        ...
        <section id="team" className="relative py-24">
          <Container>
            <div className="text-center mb-14">
              <Eyebrow color="#00e5a0">Founding team</Eyebrow>
              ...
              {team.map((m) => (
                <div key={m.name} className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 text-center">
                  <div
                    ...
                    style={{ background: 'linear-gradient(135deg, rgba(255,122,31,0.6), rgba(224,64,160,0.6))' }}
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src={m.photo}
        ...
        <section id="schools" className="relative py-24 scroll-mt-20">
          <Container className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col">
              <Eyebrow color="#e040a0">Partners</Eyebrow>
              <div className="flex-1 flex flex-col justify-center rounded-2xl border border-white/10 bg-white/[0.03] p-8">
                <p className="text-2xl font-bold mb-3" style={{ color: '#00e5a0' }}>Growing Up Greatness</p>
      ...
      {/* ══ FOOTER ══ */}
      <footer className="bg-[#020908] text-white/45 py-10 border-t border-white/10">
